...
<div class="max-w-7xl mx-auto w-full px-0 sm:px-4 lg:px-6">
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            ...
            {{-- Card: Dashboard --}}
            <a href="{{ route('timesheet.index') }}" class="module-card relative theme-bg-card rounded-xl border border-slate-700 p-4 lg:p-6 hover:border-orange-500/50 transition group">
                <div class="relative z-10">
                    <div class="module-icon w-12 h-12 lg:w-14 lg:h-14 bg-orange-500/20 rounded-xl flex items-center justify-center mb-3 lg:mb-4 transition">
                        <i class="fas fa-chart-line text-orange-500 text-xl lg:text-2xl"></i>
                    </div>
                    <h3 class="text-base lg:text-lg font-bold mb-1 lg:mb-2 theme-text-primary">Dashboard de Projetos</h3>
                    <p class="text-xs lg:text-sm theme-text-secondary mb-3 lg:mb-4 line-clamp-2">Métricas de Horas trabalhadas por Projetos.</p>
    ...
    {{-- ============================================================
         CATEGORIA 2 — GESTÃO DOS TIMESHEETS (apenas ADMIN)
         ============================================================ --}}
    @role('ADMIN')
    <div class="mb-8">
        <h2 class="text-lg font-bold mb-4 flex items-center gap-2 theme-text-primary">
            <i class="fas fa-folder-tree text-rose-500"></i>
            Gestão de Apontamentos
        </h2>
        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">

            {{-- Card: Match de Projetos --}}
            <a href="{{ route('timesheet.index') }}" class="module-card relative theme-bg-card rounded-xl border border-slate-700 p-4 lg:p-6 hover:border-red-500/50 transition group">
                <div class="relative z-10">
                    <div class="module-icon w-12 h-12 lg:w-14 lg:h-14 bg-red-500/20 rounded-xl flex items-center justify-center mb-3 lg:mb-4 transition">
                        <i class="fas fa-check-circle text-red-500 text-xl lg:text-2xl"></i>
                    </div>
                    <h3 class="text-base lg:text-lg font-bold mb-1 lg:mb-2 theme-text-primary">Match de Clientes</h3>
                    <p class="text-xs lg:text-sm theme-text-secondary mb-3 lg:mb-4 line-clamp-2">Análise de match entre Clientes e Projetos Ativos.</p>
                    
                    <div class="flex items-center text-red-500 group-hover:opacity-80 transition">
                        <span class="text-xs lg:text-sm font-medium">Acessar</span>
                        <i class="fas fa-arrow-right ml-2 transform group-hover:translate-x-1 transition-transform"></i>
                    </div>
                </div>
